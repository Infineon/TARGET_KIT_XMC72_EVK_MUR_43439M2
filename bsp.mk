...
#
# \brief
# Define the KIT-XMC72-EVK-MUR-43439M2 target.
#
################################################################################
# \copyright
...
BSP_COMPONENTS:=XMC7x_CM0P_SLEEP WIFI_INTERFACE_SDIO

# Any additional defines to apply when using this board.
BSP_DEFINES:=CY_USING_HAL CYBSP_WIFI_WL_REG_ON_GPIO_DRIVE_MODE=CYHAL_GPIO_DRIVE_STRONG CYBSP_WIFI_WL_HOSTWAKE_DRIVE_MODE=CYHAL_GPIO_DRIVE_PULLUP CYBSP_WIFI_WL_HOSTWAKE_INIT_STATE=WHD_TRUE CYBSP_WIFI_HOST_WAKE_IRQ_EVENT=CYHAL_GPIO_IRQ_FALL
...
MPN_LIST:=XMC7200D-E272K8384 LBEE5KL1YN
DEVICE:=XMC7200D-E272K8384
ADDITIONAL_DEVICES:=CYW43439KUBG
DEVICE_COMPONENTS:=43439 CAT1 CAT1C CAT1C8M HCI-UART MURATA-1YN
...
DEVICE_LIST:=XMC7200D-E272K8384 CYW43439KUBG
DEVICE_TOOL_IDS:=bsp-assistant bt-configurator device-configurator dfuh-tool library-manager memory-analyzer motor-suite-gui project-creator qspi-configurator smartio-configurator
